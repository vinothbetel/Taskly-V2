...
export const MobileTaskCard = memo(function MobileTaskCard({
  ...
  const [hasViewedComments, setHasViewedComments] = useState(false); // New state to track if comments have been viewed
  ...
  // Determine if the task has been commented on recently for highlighting
  // Now also checks if comments have been viewed locally
  const isRecentlyCommented = task.lastCommentedAt && 
    (Date.now() - new Date(task.lastCommentedAt).getTime() < 5 * 60 * 1000) && !hasViewedComments; // Within last 5 minutes
    ...
    <div className="flex flex-col mb-3">
      <Card 
        ...
        className={cn(
          ...
          "min-h-[100px] shadow-md hover:shadow-lg",
          ...
          isRecentlyCommented && "border-l-4 border-l-blue-500 bg-blue-50/10 dark:bg-blue-900/10 animate-pulse-glow", // Highlight style
      ...
      >
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0 space-y-3">
              <div className="flex items-start justify-between gap-3">
                <h3 className={cn(
                  "font-semibold text-base leading-relaxed line-clamp-2",
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <Button
                    onClick={(e) => {
                      ...
                      setHasViewedComments(true); // Mark as viewed when expanded
                      impact('light');
                    }}
                    variant="ghost"
                    size="sm"
        ...
        <div className="px-4 py-0 border-t border-border/30">
          <TaskComments 
            taskId={task.id} 
        ...
        {task.subtasks && (task.subtasks.length > 0 || !isCompleted) && (
          <div className="px-4 pt-3 py-0 border-t border-border/30"> {/* Added pt-3 here */}
